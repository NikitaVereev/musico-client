...
const FieldsAcoustic: FC<{ productId: string | null}> = ({ productId}) => {
    const {
        handleSubmit,
        register,
        formState: { errors },
    ...
    const { mutateAsync } = useMutation(
        (data: any) => ProductServices.createFeatures('acoustic-guitar',productId, data),
    ...
    return (
        <><form  onSubmit={
            ...
            />
            <Field
                placeholder="Колковая иеханика"
                {...register('Колковая иеханика', )}
                name="Колковая иеханика"
            />
